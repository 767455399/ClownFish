...
import com.example.administrator.clownfish.tool.MyAdapter;
import com.example.administrator.clownfish.tool.PullRelativeLayout;
import com.example.administrator.clownfish.view.HeaderFrameLayout;
import com.example.administrator.clownfish.view.OutScrollView;

public class DoublePullActivity extends AppCompatActivity implements PullRelativeLayout.OnStateChangeListener,OutScrollView.OnScrollStateChangeListener,View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_double_pull);
        initView();
        initData();
        initListener();
    }
