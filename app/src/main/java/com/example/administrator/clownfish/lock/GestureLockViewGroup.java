package com.example.administrator.clownfish.lock;
...
import com.example.administrator.clownfish.lock.GestureLockView.Mode;
...
public class GestureLockViewGroup extends RelativeLayout
{
     ...
     * 存储答案
     */
    private int[] mAnswer = { 1,2,3,6,5,4 };
    /**
     ...
     */
    private int mFingerUpColor = 0xFF378FC9;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        if (mGestureLockViews == null)
        {
            ...
            mPaint.setStrokeWidth(mGestureLockViewWidth * 0.03f);
